...
class BostadDirektScraper(PlaywrightBaseScraper):
    ...
    BostadDirekt is a platform for direct rental listings from landlords.
    ...
    def get_search_url(self) -> str:
        ...
        return (
            f"{self.base_url}/hyra/stockholm"
        ...
        try:
            ...
            for scroll_attempt in range(10):
                ...
                links = [l for l in soup.find_all("a", href=True)
                        if "/lagenhet/" in l.get("href", "") or "/objekt/" in l.get("href", "")]
            ...
            for link in soup.find_all("a", href=True):
                href = link.get("href", "")
                if "/lagenhet/" in href or "/objekt/" in href:
