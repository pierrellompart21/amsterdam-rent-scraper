"""Hemavi.com scraper - Modern Swedish rental marketplace (JavaScript rendered)."""
...
class HemaviScraper(PlaywrightBaseScraper):
    ...
    Hemavi is a modern rental marketplace in Sweden.
    The site requires JavaScript rendering.

    URL patterns:
    - Search: https://hemavi.com/sok?location=stockholm&type=hyresratt
    - Listing: https://hemavi.com/bostad/{id}
    """
    ...
    def get_search_url(self) -> str:
        ...
        return f"{self.base_url}/sok?location=stockholm&type=hyresratt"
    ...
    def get_listing_urls(self, page: Page) -> list[str]:
        ...
        try:
            ...
            # TODO: Adjust selector based on actual Hemavi HTML structure
