...
class SamtryggScraper(PlaywrightBaseScraper):
    ...
    Samtrygg is a rental platform with tenant insurance focus.
    The site requires JavaScript rendering.

    URL patterns:
    - Search: https://www.samtrygg.se/hyra-ut-bostad/lediga-bostader?region=stockholm
    - Listing: https://www.samtrygg.se/bostad/{id}
    """
    ...
    def get_search_url(self) -> str:
        ...
        return f"{self.base_url}/hyra-ut-bostad/lediga-bostader?region=stockholm"
    ...
    def get_listing_urls(self, page: Page) -> list[str]:
        ...
        try:
            ...
            # TODO: Adjust selector based on actual Samtrygg HTML structure
