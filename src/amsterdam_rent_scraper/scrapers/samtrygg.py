"""Samtrygg.se scraper - Swedish rental platform with tenant insurance (JavaScript rendered)."""
...
class SamtryggScraper(PlaywrightBaseScraper):
    ...
    Samtrygg is a rental platform with tenant insurance.
    ...
    def get_search_url(self) -> str:
        ...
        return (
            f"{self.base_url}/lediga-lagenheter/stockholm"
        ...
        try:
            ...
            for scroll_attempt in range(10):
                ...
                links = [l for l in soup.find_all("a", href=True)
                        if "/lagenhet/" in l.get("href", "") or "/bostad/" in l.get("href", "")]
