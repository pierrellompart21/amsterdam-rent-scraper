"""HomeQ.se scraper - Swedish digital rental platform (JavaScript rendered)."""
...
class HomeQScraper(PlaywrightBaseScraper):
    ...
    HomeQ is a digital rental platform connecting landlords and tenants.
    ...
    def get_search_url(self) -> str:
        ...
        return (
            f"{self.base_url}/hyresratter/stockholm"
