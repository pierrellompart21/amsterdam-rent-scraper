"""Bostadsportalen.se scraper - Swedish rental listings aggregator (JavaScript rendered)."""
...
class BostadsportalenScraper(PlaywrightBaseScraper):
    ...
    Bostadsportalen is a rental listings aggregator for Sweden.
    ...
    def get_search_url(self) -> str:
        ...
        return (
            f"{self.base_url}/sok/hyresratter/stockholm"
        ...
        try:
            ...
            for scroll_attempt in range(10):
                ...
                links = [l for l in soup.find_all("a", href=True)
                        if "/objekt/" in l.get("href", "") or "/bostad/" in l.get("href", "")]
            ...
            for link in soup.find_all("a", href=True):
                href = link.get("href", "")
                if "/objekt/" in href or "/bostad/" in href:
