...
COLUMN_ORDER = [
    ...
    ("neighborhood_overall", "Area Score"),
    ("neighborhood_safety", "Safety"),
    ("neighborhood_green_space", "Green Space"),
    ("neighborhood_amenities", "Amenities"),
    ("neighborhood_restaurants", "Restaurants"),
    ("neighborhood_family_friendly", "Family"),
    ("neighborhood_expat_friendly", "Expat"),
